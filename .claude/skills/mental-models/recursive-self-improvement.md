...
- **Elevate humans for paradigm decisions.** Which direction to explore, what to build next, when to abandon an approach — these need human judgment or at minimum, structured exploration (see prompt-evolution).
