...
Standalone skills (no imports): `api_key_checker`, `concise_writing`, `data_science`, `forecast`, `gh_cli`, `jina_grep`, `modal`, `pdf_to_markdown`, `pr_review`, `skill_pruner`, `skill_stealer`
