...
- **Don't duplicate session-planner.** This skill says "here's what's going on." Session planner says "here's what to work on." The user runs this first, then optionally runs session-planner.
