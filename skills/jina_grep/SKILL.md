...
description: >
  ...
  Use when the user wants semantic code search, natural language grep,
  or zero-shot text classification over local files. Do NOT use for
  exact string matching (use grep/rg directly) or non-macOS systems.
