...
name: staff-engineer
description: >
  Applies rigorous engineering standards, anti-sycophancy, and structured
  debugging. Use when writing production code, reviewing architecture,
  optimizing performance, doing code review, or debugging. Triggers on
  "debug this", "why is this failing", "review this code", "production
  quality", "code review", or when tests are failing and the cause is
  unclear. Do NOT use for quick prototypes, throwaway scripts, or
  exploratory code.
---
