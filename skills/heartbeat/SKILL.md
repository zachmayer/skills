...
- **Prior art review first.** Load the `prior_art_review` skill and run the "For PR Reviews" section to calibrate against the repo's standards — what gets approved, what gets rejected, common feedback themes.
...
**Prior art review first.** Load the `prior_art_review` skill and run the "For Issues" section.
