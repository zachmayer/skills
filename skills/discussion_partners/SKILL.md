...
| `openai:codex-mini-latest` | Coding specialist — code review, debugging, refactors | `OPENAI_API_KEY` |
...
uv run --directory SKILL_DIR python scripts/ask_model.py -m openai:gpt-5-codex "question"
