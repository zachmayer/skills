...
| `openai-responses:codex-mini-latest` | Fast coding partner; coding-focused reasoning | `OPENAI_API_KEY` |
| `openai-responses:gpt-5-codex` | Deep coding analysis via Responses API | `OPENAI_API_KEY` |
