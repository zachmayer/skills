...
uv run --directory SKILL_DIR python scripts/ask_model.py -m google-gla:gemini-2.5-pro "question"

# Gemini 3.1 Pro with thinking enabled
uv run --directory SKILL_DIR python scripts/ask_model.py -m google-gla:gemini-3.1-pro "question"
