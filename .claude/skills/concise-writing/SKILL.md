...
description: >
  Enforces tight, scannable prose in all writing output. Use when the user
  says "write", "draft", "summarize", "document", "README", "message",
  "announcement", or any task producing prose — technical docs, commit
  messages, PR descriptions, emails, reports. Applies conciseness rules:
  cut filler, active voice, lead with the point, concrete over abstract.
  Do NOT use for creative writing, fiction, or when the user explicitly asks
  for verbose/detailed explanations.
---
